...
restaurant1 = Restaurant(name="Urban Burger", category="American")
...
restaurant2 = Restaurant(name = "Super Stir Fry", category="Chinese")
...
restaurant1 = Restaurant(name = "Panda Garden", category="Chinese")
...
restaurant1 = Restaurant(name = "Thyme for That Vegetarian Cuisine ", category="Vegetarian")
...
restaurant1 = Restaurant(name = "Tony\'s Bistro ", category="Italian")
...
#Menu for Andala's
restaurant1 = Restaurant(name = "Andala\'s", category="Indian")
...
restaurant1 = Restaurant(name = "Auntie Ann\'s Diner'", category="American")
...
restaurant1 = Restaurant(name = "Cocina Y Amor ", category="Mexican")
...
restaurant1 = Restaurant(name = "State Bird Provisions", category="International")
session.add(restaurant1)
session.commit()
