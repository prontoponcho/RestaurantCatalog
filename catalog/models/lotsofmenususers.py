...
restaurant2 = Restaurant(user_id=1, name="Super Stir Fry", category="Chinese")
...
restaurant1 = Restaurant(user_id=1, name="Panda Garden", category="Chinese")
...
restaurant1 = Restaurant(user_id=1, name="Thyme for That Vegetarian Cuisine", category="Vegetarian")
...
restaurant1 = Restaurant(user_id=1, name="Tony\'s Bistro", category="Italian")
...
# Menu for Andala's
restaurant1 = Restaurant(user_id=1, name="Andala\'s", category="Indian")
...
restaurant1 = Restaurant(user_id=1, name="Auntie Ann\'s Diner'", category="American")
...
restaurant1 = Restaurant(user_id=1, name="Cocina Y Amor", category="Mexican")
...
restaurant1 = Restaurant(user_id=1, name="State Bird Provisions", category="International")
session.add(restaurant1)
session.commit()
